...
const AllRooms = () => {
  ...
  const filteredRooms = searchTerm
    ? rooms.filter((room) => room.name.toLowerCase().includes(searchTerm))
    : rooms;
    ...
    <div className="min-h-screen flex flex-col bg-[#f7f0eb]">
      <div className="grow pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-serif text-center mb-4 text-gray-800">
            All Rooms
          </h1>
          ...
          {searchTerm && (
            <p className="text-center text-gray-600 mb-6">
              ...
              <Link to="/rooms" className="text-[#C27E35] underline">
                clear search
              </Link>
            </p>
          )}
