...
const About = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20 font-serif">
      ...
      {/* Content */}
      <div className="relative max-w-6xl bg-white/10 backdrop-blur-md border border-amber-300 rounded-2xl p-10 md:p-16 text-white shadow-2xl">
        <p className="uppercase tracking-[8px] text-amber-300 text-sm">
        ...
        <p className="text-lg leading-9 text-gray-200">
          Welcome to{" "}
          <span className="text-amber-300 font-semibold">Hotel Ease</span>,
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-12">
          <div>
            <h2 className="text-2xl text-amber-300 mb-4">Our Story</h2>
          ...
          <div>
            <h2 className="text-2xl text-amber-300 mb-6">Luxury Amenities</h2>

            <div className="space-y-5">
              <div className="flex items-center gap-4">
                <FaHotel className="text-amber-300 text-2xl" />
                Luxury Suites
              </div>

              <div className="flex items-center gap-4">
                <FaUtensils className="text-amber-300 text-2xl" />
                Fine Dining
              </div>

              <div className="flex items-center gap-4">
                <FaSpa className="text-amber-300 text-2xl" />
                Spa & Wellness
              </div>

              <div className="flex items-center gap-4">
                <FaSwimmingPool className="text-amber-300 text-2xl" />
                Infinity Pool
              </div>

              <div className="flex items-center gap-4">
                <FaWifi className="text-amber-300 text-2xl" />
                High-Speed Wi-Fi
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-3xl text-amber-300">★★★★★</h3>
